...
export function DashboardPage() {
  ...
  if (!wallet.address) {
    return (
      <EmptyState
        description="Connect a wallet to open your protocol dashboard."
    ...
    <div className="space-y-8">
      <header className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <h1 className="text-5xl font-bold tracking-[-0.02em] text-white">Wallet Overview</h1>
          <p className="mt-2 max-w-2xl text-lg text-[var(--text-muted)]">
            One wallet can create auctions, bid across the marketplace, and settle deliveries.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <>
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="glass-panel rounded-2xl border-l-4 border-l-[var(--tertiary)] p-6">
            ...
            <div className="glass-panel rounded-2xl border-l-4 border-l-[var(--danger)] p-6">
          ...
          <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            <div className="glass-panel rounded-2xl p-6">
              <div className="mb-5 flex items-center justify-between gap-4">
                ...
                <Link className="text-sm font-semibold text-[var(--primary)]" to="/auctions">
                  Open Auctions
                </Link>
              </div>
              {createdAuctions.length === 0 ? (
                <EmptyState
                  description="Create your first auction and it will appear here."
            ...
            <div className="glass-panel rounded-2xl p-6">
              <div className="mb-5">
                ...
                <h2 className="mt-2 text-2xl font-semibold text-white">Bid Summary</h2>
              </div>
